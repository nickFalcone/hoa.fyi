...
module.exports = function(eleventyConfig) {
  ...
  // Directory configuration, these are all optional, defaults are shown:
  const dir = {
    input: ".",
    includes: "_includes",
    data: "_data",
  ...
  // Setup the AMP plugin
  eleventyConfig.addPlugin(pluginAmp, {
    // Passthrough the directory configuration
    dir,
    imageOptimization: {
      urlPath: "/img"
      // path the pathPrefix option if used
      // pathPrefix: '/',
    }
  });
